import argparse
import torch
from clip_utils import load_clip_resources, perform_zero_shot_classification
...
def main():
    ...
    # CLIP 相關參數
    parser.add_argument("--clip_model", type=str, default=DEFAULT_CLIP_MODEL, help="要使用的 CLIP 模型名稱 (來自 Hugging Face)")
    ...
    parser.add_argument("--diffusion_model", type=str, default=DEFAULT_DIFFUSION_MODEL, help="要使用的擴散模型 ID (來自 Hugging Face)")
